-- Pull directly from our sessionized fact table, as it already contains all the heavy lifting
...
-- 2. FILTERING LOGIC
-- Isolate sessions that meet the strict business criteria for an "abandoned cart"
abandoned_carts AS (
    SELECT 
        session_id,
        user_id,
...
-- 3. FINAL OUTPUT
-- Only output carts that have been sitting idle for 15 minutes or more.
